 ...
 * @param  {object}   tags array of tags to filter on, if null, do not use
  ...
  getAllDocks(function (err, docks) {
    ...
    if (!isEmpty(tags)) {
      docks = docks.filter(function(dock) {
        if (isEmpty(dock.tags)) { return false; }
        return dock.tags.some(function(currentTag) {
          return ~tags.indexOf(currentTag);
        });
      });
    }
 ...
 * @param {object}   tags array of tags describing the host, can be null or undefined
